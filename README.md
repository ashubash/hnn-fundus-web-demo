...
**Note**: The pipeline from training the teacher model to distilling it down to the student model was done on the RTX 5090 card. If unavailable, you can alternatively setup an environment on Runpod GPU using the RTX 5090 to get the outputs shown in Colab Notebook.
